...
- 본 권 수정: **EN 2건, KO 2건** (합계 4건). Rule ⑥(chill·bro·왕따) 변경 없음.

| 장 | 위치 | 언어 | Rule | 기존 | 수정 |
|---|---|---|---|---|---|
| 3 | p4 | EN | ⑤ | I ditched all that lame stuff | I ditched all that worthless stuff |
| 3 | 제목 | EN | ⑤ | All-In for the Win | Going All Out for the Win |
| 2 | p1 | KO | ④ | 속 깊은 찐친이 되라는 거야. | 속 깊은 진짜 친구가 되라는 거야. |
| 3 | 제목 | KO | ⑤ | 승리를 향한 올인 | 승리를 향해 전진 |
